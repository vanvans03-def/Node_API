...
// ปรับเพิ่มการกำหนด options ของ Socket.io
...
// ไม่จำเป็นต้องใช้ server.listen แล้ว เนื่องจาก Vercel จะรับ HTTP/HTTPS ให้อัตโนมัติ
// server.listen(PORT, () => {
//   console.log(`socket on ${PORT}`);
// });

module.exports = app; // เพิ่มบรรทัดนี้เพื่อใช้งานกับ Vercel
